...
type UpdateContainerForObjectFunc func(obj runtime.Object, fn func(container *v1.Container) error) (bool, error)

var UpdateContainerForObjectFn UpdateContainerForObjectFunc = updateContainerSpecForObject
